...
# Loading Data Set
```{r}
data <- read.csv("~/Documents/project2/Data/refined_somerville.csv")
...
# Bar plot showing the proportion of age in each education quality satisfaction group related to happiness
```{r}
ggplot(Somerville_data, aes(x = Happiness.num, fill = Age)) +
  geom_bar(position = "fill") +
  facet_wrap("Education.Quality.Satisfaction.label") +
  labs(title = "The Relationship Between Happiness and Education Quality \n Satisfaction among Age Groups in Somerville, MA, 2025", x = "Happiness Rating", y = "Proportion") +
  theme_minimal()
```
