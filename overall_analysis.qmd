...
```
We are 95% confident that there is a weak (r = .27) and positive correlation between Happiness and education quality satisfaction (p = 4.009e-09), indicating that Happiness is somewhat associated with education quality satisfaction. Since we are interested in how happiness relates to these metrics about Somerville, we can examine the strong correlations with Somerville satisfaction in the heatmap in relation to happiness to see how that relates as well.
